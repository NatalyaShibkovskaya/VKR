...
ALTER TABLE "employees"
  ADD CONSTRAINT "employees_fk0" FOREIGN KEY ("status") REFERENCES "statuses" ("id_stat");

ALTER TABLE "schedule"
  ADD CONSTRAINT "schedule_fk0" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");

ALTER TABLE "absence"
  ADD CONSTRAINT "absence_fk0" FOREIGN KEY ("cause") REFERENCES "causes" ("id_caus");
ALTER TABLE "absence"
  ADD CONSTRAINT "absence_fk1" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");

ALTER TABLE "calendar"
  ADD CONSTRAINT "calendar_fk0" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");

ALTER TABLE "history_positions"
  ADD CONSTRAINT "history_positions_fk0" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");
ALTER TABLE "history_positions"
  ADD CONSTRAINT "history_positions_fk1" FOREIGN KEY ("id_div") REFERENCES "divisions" ("id_div");
ALTER TABLE "history_positions"
  ADD CONSTRAINT "history_positions_fk2" FOREIGN KEY ("id_pos") REFERENCES "positions" ("id_pos");

ALTER TABLE "payment"
  ADD CONSTRAINT "payment_fk0" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");

ALTER TABLE "documents"
  ADD CONSTRAINT "documents_fk0" FOREIGN KEY ("id_empl") REFERENCES "employees" ("id_empl");
ALTER TABLE "documents"
  ADD CONSTRAINT "documents_fk1" FOREIGN KEY ("action") REFERENCES "actions" ("id_act");


CREATE TABLE "DOP".time_sheet
(
  ...
  id_empl          int                NOT NULL,
  CONSTRAINT time_sheet_empl_fk FOREIGN KEY (id_empl) REFERENCES "DOP".employees (id_empl)
);